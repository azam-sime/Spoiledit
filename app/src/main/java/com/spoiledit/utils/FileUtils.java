...
import com.spoiledit.constants.Directory;
...
//    }
    ...
    public static String getMimeType(String uri) {
        ...
        switch (fileNameParts[filePartsLength - 1]) {
            // text extensions
            case "txt":
                return com.spoiledit.constants.File.Mime.txt;
            // image extensions
            case "bmp":
                return com.spoiledit.constants.File.Mime.bmp;
            case "cgm":
                return com.spoiledit.constants.File.Mime.cgm;
            case "gif":
                return com.spoiledit.constants.File.Mime.gif;
            case "jpeg":
                return com.spoiledit.constants.File.Mime.jpeg;
            case "jpg":
                return com.spoiledit.constants.File.Mime.jpg;
            case "mdi":
                return com.spoiledit.constants.File.Mime.mdi;
            case "psd":
                return com.spoiledit.constants.File.Mime.psd;
            case "png":
                return com.spoiledit.constants.File.Mime.png;
            case "svg":
                return com.spoiledit.constants.File.Mime.svg;
            // audio extensions
            case "adp":
                return com.spoiledit.constants.File.Mime.adp;
            case "aac":
                return com.spoiledit.constants.File.Mime.aac;
            case "mpga":
                return com.spoiledit.constants.File.Mime.mpga;
            case "mp4a":
                return com.spoiledit.constants.File.Mime.mp4a;
            case "oga":
                return com.spoiledit.constants.File.Mime.oga;
            case "wav":
                return com.spoiledit.constants.File.Mime.wav;
            case "mp3":
                return com.spoiledit.constants.File.Mime.mp3;
            // video extensions
            case "3gp":
                return com.spoiledit.constants.File.Mime.a3gp;
            case "3g2":
                return com.spoiledit.constants.File.Mime.a3g2;
            case "avi":
                return com.spoiledit.constants.File.Mime.avi;
            case "xlv":
                return com.spoiledit.constants.File.Mime.xlv;
            case "m4v":
                return com.spoiledit.constants.File.Mime.m4v;
            case "mp4":
                return com.spoiledit.constants.File.Mime.mp4;
            // documents extension
            case "rar":
                return com.spoiledit.constants.File.Mime.rar;
            case "zip":
                return com.spoiledit.constants.File.Mime.zip;
            case "pdf":
                return com.spoiledit.constants.File.Mime.pdf;
            case "dvi":
                return com.spoiledit.constants.File.Mime.dvi;
            case "karbon":
                return com.spoiledit.constants.File.Mime.karbon;
            case "mdb":
                return com.spoiledit.constants.File.Mime.mdb;
            case "xls":
                return com.spoiledit.constants.File.Mime.xls;
            case "pptx":
                return com.spoiledit.constants.File.Mime.pptx;
            case "docx":
                return com.spoiledit.constants.File.Mime.docx;
            case "ppt":
                return com.spoiledit.constants.File.Mime.ppt;
            case "doc":
                return com.spoiledit.constants.File.Mime.doc;
            case "oxt":
                return com.spoiledit.constants.File.Mime.oxt;
            default:
                return "file/*";
        }
    }
