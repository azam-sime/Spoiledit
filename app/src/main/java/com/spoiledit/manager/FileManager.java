...
import com.spoiledit.listeners.OnFileActionListener;
...
public class FileManager implements OnFileSourceChoiceListener {
    ...
    public void attachFiles(Intent data) {
        attachFiles(data, null, null);
    }

    public void attachFiles(Intent data, Object observer, Object listener) {
        try {
            if (data.getData() != null) {
